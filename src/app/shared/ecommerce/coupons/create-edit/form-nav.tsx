...
export const menuItems = [
  { label: "Basic Information", value: formParts.basicInfo },
  { label: "Discount Settings", value: formParts.discountSettings },
  { label: "Applicability & Conditions", value: formParts.applicabilityConditions },
  { label: "Usage Limits", value: formParts.usageLimits },
];
